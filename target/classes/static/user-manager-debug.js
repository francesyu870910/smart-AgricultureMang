// 用户管理模块 - 调试版本
console.log('User manager debug module loading...');
...
function createModalIfNotExists() {
    console.log('Creating modal because it does not exist');
...
console.log('User manager debug module loaded successfully!');
